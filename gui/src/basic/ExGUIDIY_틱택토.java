...
class TTTPanel extends JPanel implements ActionListener{
	...
	public TTTPanel() {
		...
		this.label.setFont(new Font("", Font.PLAIN, 40));
	 ...
	 * 	// 100 * 50
	 * 	this.reset.setBounds(TicFrame.SIZE/2-50,TicFrame.SIZE/2-100,100,50)
	 * 	this.reset.addActionListener(this);
	 * 	add(this.reset);
	 * }
	 * 
	...
	public void actionPerformed(ActionEvent e) {	// 리스너 (버튼 누르면 일어나는 일)
		...
		// 눌린 버튼의 정보를 저장 후 조건문에서 trigger == 특정 버튼 ? 
		// 같은 식으로 비교를 하는게 가능
		...
		if(e.getSource() == this.reset) {
			 ...
			 * this.map[i].setBackground(new Color());
			 */
		}
